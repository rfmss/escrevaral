...
const taskNavControls = document.querySelectorAll("[data-task-nav]");
...
const writingCoach = document.querySelector("[data-writing-coach]");
const writingCoachEyebrow = document.querySelector("[data-writing-coach-eyebrow]");
const writingCoachTitle = document.querySelector("[data-writing-coach-title]");
const writingCoachBody = document.querySelector("[data-writing-coach-body]");
const writingCoachCta = document.querySelector("[data-writing-coach-cta]");
