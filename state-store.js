...
const documentTypes = [
  ...
  { id: "mundo",              label: "Mundo",                 icon: "public",                kind: "Mundo",                 chapter: "Worldbuilding",     description: "As regras do universo que você criou. Física, magia, política, história — o que vale aqui dentro." },
  ...
  { id: "cena-roteiro",       label: "Cena de roteiro",       icon: "theaters",              kind: "Cena de roteiro",       chapter: "Roteiro",           description: "Uma cena no formato de roteiro. Slug line, ação, diálogo — o que vai para a tela." },
