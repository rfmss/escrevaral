# Auditoria de Dados Linguisticos - 2026-07-01
...
- **[morfologia/listas] Colisoes verbo-adjetivo aparecem apos tirar acento**
  - Evidencia: norma adjetivos_comuns: `íntegra` -> `integra`; syntax ADJETIVOS_PRIM: `pública` -> `publica`; syntax ADJETIVOS_PRIM: `público` -> `publico`; syntax ADJETIVOS_PRIM: `séria` -> `seria`; syntax ADJETIVOS_PRIM: `sérias` -> `serias`
...
- **[norma-data.json/adjetivos_comuns] Adjetivos da norma colidem com presente verbal regular (mitigado por guarda adnominal 2-token no VERBOS_PRES)**
  - Evidencia: `completa`, `critica`, `estreita`, `estreito`, `precisa`
