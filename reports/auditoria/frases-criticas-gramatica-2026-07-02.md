# Bancada gramatical - frases criticas - 2026-07-02
...
O romance integra elementos do mito indígena à narrativa urbana contemporânea com naturalidade.

- `integra`: esperado `Verb`; observado integra=[Adjective]; status `divergente`

Tokens: O=[Determiner,Noun] romance=[Noun] integra=[Adjective] elementos=[Noun] do=[Preposition] mito=[Noun] indígena=[Noun] à=[Preposition] narrativa=[Adjective] urbana=[Adjective] contemporânea=[Noun] com=[Preposition] naturalidade=[Noun] .=[-]

### r-verb-fabular-01

O escritor fabula porque o real já aconteceu e só a fabulação o torna legível.

- `fabula`: esperado `Verb`; observado fabula=[Noun]; status `divergente`

Tokens: O=[Determiner,Noun] escritor=[Noun] fabula=[Noun] porque=[Conjunction] o=[Determiner] real=[Adjective] já=[Adverb] aconteceu=[Verb] e=[Conjunction] só=[Adverb] a=[Determiner] fabulação=[Noun] o=[Determiner] torna=[Noun] legível=[Adjective] .=[-]
...
- `divergente` `r-verb-integra-01`: O romance integra elementos do mito indígena à narrativa urbana contemporânea com naturalidade.
...
- `divergente` `r-verb-fabular-01`: O escritor fabula porque o real já aconteceu e só a fabulação o torna legível.
