...
(function(global) {
  ...
  const SINONIMOS = {
    ...
    "crianca":     ["criança", "infante", "menino", "menina", "pequeno", "rebento", "jovem"],
    ...
    "catarse":       ["purificação emocional", "alívio dramático", "descarga", "comoção", "liberação"],
    ...
    "indignação":    ["revolta", "ultraje", "cólera", "inconformidade", "protesto"],
