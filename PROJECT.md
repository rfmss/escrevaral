...
| V8/Linux da oficina | Testes e medições locais | 467 verificações aprovadas, sintaxe ES5, equivalência portátil e cenários com rede/APIs modernas bloqueadas |
...
O arquivo portátil após a rodada de papel, foco e impressão tem 638.258 bytes (entrega anterior de engines: 456.821). A bancada não representa tempo de WebKit, memória do iPad nem taxa geral de acerto linguístico. Medições e limites estão em `astra/MATURACAO.md`.
