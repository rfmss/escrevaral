...
- sistema visual passa a compartilhar escala curta de espaçamento, tipografia, raios e tamanho mínimo de controles;
- painéis laterais usam composição compacta em notebooks para preservar a largura do manuscrito;
- navegação e controles recorrentes passam a compartilhar dimensões e estados de interação;
- bandeja mobile isola o conteúdo de fundo enquanto está aberta;
