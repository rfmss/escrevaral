(function archiveEngine(global) {
  ...
  const META_TEMPLATES = {
    ...
    cena: {
      ...
      fields: [
        ...
        { key: "lugar", label: "Lugar", hint: "Nome do lugar criado no acervo — ex: Mansão Alvorada", type: "ref" },
        { key: "personagens", label: "Personagens", hint: "Nomes dos personagens presentes, um por linha", type: "array" },
    ...
    mundo: {
      ...
      fields: [
        ...
        { key: "lugares", label: "Lugares", hint: "Nomes dos lugares que pertencem a este mundo", type: "array" },
        { key: "instituições", label: "Instituições", hint: "Nomes das instituições deste mundo", type: "array" },
      ],
    },
    lugar: {
      ...
      fields: [
        ...
        { key: "mundo", label: "Mundo pai", hint: "Nome do mundo ao qual este lugar pertence, se você tiver criado um", type: "ref" },
        ...
        { key: "personagens", label: "Personagens frequentes", hint: "Nomes dos personagens que vivem ou frequentam este lugar", type: "array" },
      ],
    },
    instituição: {
      ...
      fields: [
        ...
        { key: "membros", label: "Membros", hint: "Nomes dos personagens que fazem parte desta instituição", type: "array" },
        { key: "mundo", label: "Mundo", hint: "Nome do mundo onde esta instituição existe", type: "ref" },
      ],
    },
    objeto: {
      ...
      fields: [
        ...
        { key: "dono", label: "Dono atual", hint: "Nome do personagem que possui este objeto", type: "ref" },
    ...
    cronologia: {
      ...
      fields: [
        ...
        { key: "personagens", label: "Envolvidos", hint: "Nomes dos personagens envolvidos neste evento", type: "array" },
      ],
    },
    capítulo: {
      ...
      fields: [
        ...
        { key: "cenas", label: "Cenas filhas", hint: "Títulos das cenas que compõem este capítulo", type: "array" },
      ],
    },
    tema: {
    ...
    entrevista: {
      ...
      fields: [
        { key: "fonte", label: "Fonte", hint: "Nome da fonte entrevistada, conforme cadastrada no acervo", type: "ref" },
    ...
    fato: {
      ...
      fields: [
        ...
        { key: "pauta", label: "Pauta relacionada", hint: "Nome da pauta onde este fato será usado", type: "ref" },
      ],
    },
    poema: {
      ...
      fields: [
        ...
        { key: "série", label: "Série / ciclo", hint: "Nome do ciclo ou série ao qual este poema pertence", type: "ref" },
  ...
  function normalizeManuscript(manuscript) {
    ...
    return {
      ...
      templateId: manuscript.templateId || undefined,
    };
  }
