(function voiceEngine(global) {
  ...
  const emotionLexicons = {
    melancolia: ["saudade", "silêncio", "perda", "ausência", "noite", "vazio", "memória", "choro", "triste", "longe", "sombra", "tarde", "cinza", "ruína", "fim", "esquecimento", "desvanecer", "apagar", "distância", "abandono", "luto", "resto", "vestígio", "espelho", "cinzas", "cansaço", "derrota", "lágrima", "sombrio", "solidão", "bruma", "desolação", "nostálgico"],
    tensao: ["medo", "sangue", "grito", "pressa", "risco", "ameaça", "culpa", "segredo", "fuga", "corte", "queda", "tensão", "perigo", "escuro", "susto", "perseguição", "armadilha", "traição", "disparo", "confronto", "urgência", "crise", "navalha", "pânico", "veneno", "emboscada", "cilada", "alarme", "nervoso", "sufoco", "paralisia", "apreensão"],
    luminosidade: ["luz", "sol", "claro", "riso", "alegria", "manhã", "brilho", "flor", "aberto", "leve", "calma", "clareza", "fresco", "verde", "esperança", "amanhecer", "celebração", "leveza", "plenitude", "festa", "graça", "sorte", "vitória", "nascer", "despertar", "glória", "aurora", "radiante", "harmonia", "dançar", "pleno", "florir"],
    ...
    contemplacao: ["olhar", "tempo", "vento", "água", "terra", "janela", "casa", "corpo", "mundo", "devagar", "espera", "pausa", "quieto", "lento", "silêncio", "horizonte", "repouso", "contemplar", "observar", "meditar", "divagar", "profundo", "névoa", "crepúsculo", "bruma", "quietude", "sereno", "tranquilo", "distância", "pensar", "imóvel", "flutuante"],
    ternura: ["gentil", "amor", "carinho", "afeto", "cuidado", "abraço", "beijar", "suave", "doce", "mãe", "filho", "criança", "delicado", "calor", "acolher", "proteção", "ternura", "lar", "família", "pertencer", "bençao", "amparo", "beijo", "sorriso", "gesto", "mimo", "meigo", "afetuoso", "embrulhar", "ninado", "seguro", "aninhar"],
  };
