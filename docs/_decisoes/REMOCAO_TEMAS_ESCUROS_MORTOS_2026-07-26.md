...
- `ASSET_VERSION`: `20260726-text-muted-contrast-v1` → `20260726-remove-dead-dark-themes-v1`;
- `CACHE_NAME`: `vereda-offline-v960` → `vereda-offline-v961`;
...
Após o squash merge do PR #134, esta branch foi reconstruída sobre a nova `main`. O contraste corrigido de `text-muted` e o auditor permanecem preservados, e o cache avança de forma estritamente crescente para `v961`.
