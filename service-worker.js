...
const ASSET_VERSION = "20260726-text-muted-contrast-v1";
...
const CORE_ASSETS = [
  ...
  "./css/13-editor-quiet.css?v=20260726-text-muted-contrast-v1",
  ...
  "./css/14-archive-inspector.css?v=20260726-text-muted-contrast-v1",
