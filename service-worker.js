const CACHE_NAME = "vereda-offline-v961";
const ASSET_VERSION = "20260726-remove-dead-dark-themes-v1";
...
const CORE_ASSETS = [
  ...
  "./css/13-editor-quiet.css?v=20260726-remove-dead-dark-themes-v1",
  ...
  "./css/14-archive-inspector.css?v=20260726-remove-dead-dark-themes-v1",
