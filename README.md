...
As convenções compartilhadas da interface estão em [`docs/VISUAL-SYSTEM.md`](docs/VISUAL-SYSTEM.md).
...
Contato geral: use as issues do repositório. Relatos sensíveis devem seguir a [`SECURITY.md`](SECURITY.md).
