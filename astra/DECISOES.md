...
A mesa ocupa até 820 px, com 680 px reservados ao manuscrito e uma cronologia à direita. A revisão de design aprovada usa papel branco gesso (#f5f4ef), tinta grafite (#282925), superfície rebaixada (#e9e9e2), texto secundário (#62635d) e bordas funcionais (#85867e). Arial unifica a interface; Courier Prime Regular fica exclusivamente no editor. Data abaixo do título e instrumentos sob a folha permanecem. Roteiro é o tema inicial; preferências explícitas por Folha são preservadas. A textura usa gradientes discretos. O editor recebe um deslocamento de tinta de 0,2 px, com opacidade baixa e sem desfoque; a impressão remove esse efeito. A fonte WOFF é incorporada em fonte-editor.css, com licença OFL integral, origem e hashes; a edição portátil inclui tudo. A CSP permite fontes data:, sem fontes remotas. Roteiro e Folha mantêm a mesma tipografia, variando a textura do papel. O horário ativo usa fundo transparente, texto grafite e um filete lateral. O alvo de toque permanece amplo; a massa escura deixa de disputar atenção com a escrita. Lentes selecionadas também usam apenas contorno e filete.

A cronologia abre folhas reais e o botão + cria e guarda uma folha, mesmo vazia. Horários usam HH:MM:SS e a data de criação permanece fixa ao editar. Um identificador estável conserva a ordem quando há criações no mesmo milissegundo; chaves de gravação continuam únicas. A roleta vertical usa rolagem nativa por toque, roda do mouse e teclado. Começa com 40 folhas; ao alcançar o início, acrescenta até 40 anteriores, mantendo a posição visual. Abrir ou criar revela a folha ativa; salvar preserva a rolagem. Folhas antigas usam a última data conhecida, marcada como aproximação, sem inventar criação. Datas locais não são prova de anterioridade. Os metadados da cronologia ficam em memória durante a digitação para evitar reler todo o acervo a cada salvamento. Em telas de até 650 px, a cronologia passa para cima da folha para preservar a largura de escrita. São escolhas de ergonomia coerentes com a Constituição, não resultados de ensaios neurocientíficos nesta sessão. Não há alegação clínica ou garantia de acessibilidade validada.
...
## Conferência da revisão de design

Cinco tons-base e duas famílias principais; rótulos antes em 11–12 px passam a 14 px. Contraste nominal: manuscrito/gesso 13,30:1; texto secundário/gesso 5,51:1; contorno do editor/gesso 3,34:1. São cálculos de cores sólidas, não certificação de acessibilidade ou medição de tela e-ink. Glifos PT-BR, licença incorporada e ausência de URLs remotas na fonte foram conferidos. A regra de foco moderna fica separada das regras compatíveis com navegadores antigos. A fonte e o efeito de tinta ainda precisam de conferência visual no aparelho.

## Marca fornecida pelo autor

A marca enviada em Escrevaral_Marca_Positiva.svg mantém sua geometria na assinatura do rodapé, em grafite. O ajuste principal está no enquadramento e respiro, sem redesenho das travessas inclinadas. O favicon recebe enquadramento quadrado, fundo branco e montantes discretamente reforçados (50 unidades em vez de aproximadamente 44) para redução. SVG para navegadores atuais e PNG de 32/180 px como alternativas; imagens incorporadas na edição portátil. A marca aparece no rodapé e nos ícones, preservando o espaço do manuscrito. São decisões de composição e redução, sem alegar uma lei universal ou ensaio de atenção com escritores.
