...
A cronologia abre folhas reais e o botão + cria e guarda uma folha, mesmo vazia. Horários usam HH:MM:SS e a data de criação permanece fixa ao editar. Um identificador estável conserva a ordem quando há criações no mesmo milissegundo; chaves de gravação continuam únicas. A roleta vertical usa rolagem nativa por toque, roda do mouse e teclado. Começa com 40 folhas; ao alcançar o início, acrescenta até 40 anteriores, mantendo a posição visual. Abrir ou criar revela a folha ativa; salvar preserva a rolagem. Folhas antigas usam a última data conhecida, marcada como aproximação, sem inventar criação. Datas locais não são prova de anterioridade. Os metadados da cronologia ficam em memória durante a digitação para evitar reler todo o acervo a cada salvamento. Em telas de até 430 px, a cronologia passa para cima da folha para preservar a largura de escrita. São escolhas de ergonomia coerentes com a Constituição, não resultados de ensaios neurocientíficos nesta sessão. Não há alegação clínica ou garantia de acessibilidade validada.
